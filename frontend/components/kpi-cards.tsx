...
const kpiData = [
  {
    ...
    details: {
      ...
      breakdown: [
        { label: "Product Sales", value: "₹1,24,000", percentage: "80%" },
        { label: "Service Revenue", value: "₹21,000", percentage: "13.5%" },
        { label: "Other Income", value: "₹10,000", percentage: "6.5%" },
      ],
      metrics: [
        { icon: Calendar, label: "This Month", value: "₹1,55,000" },
        { icon: Users, label: "Active Customers", value: "127" },
        { icon: Target, label: "Monthly Goal", value: "₹1,80,000" },
  ...
  },
  {
    ...
    details: {
      ...
      breakdown: [
        { label: "Gross Profit", value: "₹85,000", percentage: "100%" },
        { label: "Operating Expenses", value: "₹32,000", percentage: "37.6%" },
        { label: "Taxes", value: "₹11,000", percentage: "12.9%" },
      ],
      metrics: [
        { icon: TrendingUp, label: "Profit Margin", value: "27.1%" },
        { icon: Target, label: "Quarterly Goal", value: "₹1,50,000" },
        { icon: Calendar, label: "YTD Profit", value: "₹3,84,000" },
  ...
  },
  {
    ...
    details: {
      ...
      breakdown: [
        { label: "0-30 days", value: "₹52,000", percentage: "62.7%" },
        { label: "31-60 days", value: "₹21,000", percentage: "25.3%" },
        { label: "60+ days (Overdue)", value: "₹10,000", percentage: "12%" },
      ],
      metrics: [
  ...
  },
  {
    ...
    details: {
      ...
      breakdown: [
        { label: "Due within 7 days", value: "₹12,000", percentage: "57.1%" },
        { label: "Due within 30 days", value: "₹7,000", percentage: "33.3%" },
        { label: "Due later", value: "₹2,000", percentage: "9.5%" },
      ],
      metrics: [
